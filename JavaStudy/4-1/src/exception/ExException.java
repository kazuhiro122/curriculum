...
public class ExException {
       ...
       do {
           ...
           try {
               ...
               switch (parameter) {
                   ...
                   // ここへ記述
                   int[] arrayException = new int[3];
                   System.out.println(arrayException[5]);
                   break;
    ...
    */
   // ここへ記入
   private static void throwsNull() throws NullPointerException {
	   String hoge = null;
	   try {
		    if (!CONST_MSG_NULLPO.equals(hoge)) {
